...
import 'bunsickhome_model.dart';
export 'bunsickhome_model.dart';

class BunsickhomeWidget extends StatefulWidget {
  const BunsickhomeWidget({super.key});

  @override
  State<BunsickhomeWidget> createState() => _BunsickhomeWidgetState();
}

class _BunsickhomeWidgetState extends State<BunsickhomeWidget> {
  late BunsickhomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BunsickhomeModel());
  }
                      ...
                      children: [
                        Padding(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(8.0),
                            child: Image.asset(
                              'assets/images/_2024-08-06__10.08.03.png',
                              width: 300.0,
                              height: 300.0,
                              fit: BoxFit.cover,
                            ),
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'm8pmnzcv' /* 정성 가득한 한 그릇으로 기분 좋은 한 끼를 즐길 수 ... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                        ...
                        child: Checkbox(
                          ...
                          onChanged: (newValue) async {
                            ...
                            if (newValue!) {
                              ...
                              setState(() {});
                              FFAppState().removeFromFshop('한쌈더분식');
                              setState(() {});
                            }
                          },
                          side: BorderSide(
